...
A simple emoji memory game: find 20 matching pairs as quickly as possible. Your best times are saved locally and shown in the "Top 10 Memory Masters" leaderboard.

## Playing
1. Open `index.html` in your browser.
2. Click cards to flip them and find all 20 pairs.
